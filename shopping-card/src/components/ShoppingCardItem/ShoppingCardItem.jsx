        ...
        <article className="shopping-cart__item-container" style="text-decoration: none;">
                ...
                <div className="shopping-cart__item-actions">
                   <button className="shopping-cart__item--buy-btn">
                      <span>Buy</span>
                      <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="dollar-sign" className="svg-inline--fa fa-dollar-sign " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" style="padding-left: 8px;">
                   ...
                   <button className="shopping-cart__item--remove-btn">
                      <span>Remove</span>
                      <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" className="svg-inline--fa fa-trash " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="padding-left: 8px;">
